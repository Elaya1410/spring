					...
					<table class="table table-striped table-hover"
						...
						<thead>
							<tr>
								...
								<th scope="col"><div class="form-group">
										<th>
											<div for="ModelNo1">Mobile One</div> <select
											class="form-control" id="ModelNo1">
								...
								<th scope="col"><div class="form-group">
										<th><div for="ModelNo2">Mobile Two</div> <select
											class="form-control" id="ModelNo2">
												<option value="">--Select One--</option>
												<c:forEach items="${SmartPhone}" var="smartphone">
													<option class="hide${smartphone.id}"
														value="${smartphone.id}"
						...
						<tbody>
							...
							<tr>
								...
								<c:forEach items="${SmartPhoneCompare}" var="smartphone">
									<td><a href="#"> <img src="${smartphone.image_url}"width="200" height="250">
									</a></td>
								</c:forEach>
							</tr>
							<tr>
